/*
 ...
 Date: 12/06/2026 08:58:00
*/
CREATE DATABASE IF NOT EXISTS `neusoft_elderly_care` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '床位管理表' ROW_FORMAT = Dynamic;
...
INSERT INTO `bed` VALUES (32, '501', '2', '空闲', NULL, '2026-06-08 15:38:06', '2026-06-08 15:38:06', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '服务关注表' ROW_FORMAT = Dynamic;
...
INSERT INTO `care_service` VALUES (20, '健康档案管理', 200.00, '建立电子健康档案', '月', '2026-06-04 14:50:39', '2026-06-04 14:50:39', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '入住登记表' ROW_FORMAT = Dynamic;
...
INSERT INTO `check_in` VALUES (31, 'CI20260608-001', 3, 31, '2026-06-10', 10, 10.00, '健康管家', '2026-06-08 16:01:36', '2026-06-08 16:01:36', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '退住登记表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '客户管理表' ROW_FORMAT = Dynamic;
...
INSERT INTO `customer` VALUES (20, 'CUST020', '袁秀琴', '女', 75, '110105194908301253', '13800010020', '袁梦', '2026-06-07', '身体健康', '生活自理', 1, '2026-06-04 14:50:39', '2026-06-04 14:50:39', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '膳食管理表' ROW_FORMAT = Dynamic;
...
INSERT INTO `meal` VALUES (28, 'MEAL2026052003', 3, '豆浆+小花卷', '软烂面片+鸡蛋羹', '米糊', '术后流食餐', '2026-05-20', '2026-06-04 17:52:59', '2026-06-08 11:06:10', 0, 'https://lishaohan-oss.oss-cn-beijing.aliyuncs.com/5f1615c1-a627-4337-9e07-9765d4fec0af.png');
...
INSERT INTO `meal` VALUES (32, 'MEAL2026052201', 7, '杂粮粥+鸡蛋', '软烂米饭+清蒸鳕鱼+菠菜', '小米粥', '高蛋白帕金森餐', '2026-05-22', '2026-06-04 17:52:59', '2026-06-08 11:06:59', 0, 'https://lishaohan-oss.oss-cn-beijing.aliyuncs.com/deefd1a1-339a-49ef-a37b-3faa75172d5c.png');
...
INSERT INTO `meal` VALUES (46, 'MEAL2026052603', 1, '小米粥+水煮蛋', '软米饭+青菜+鱼', '山药粥', '高血压低盐餐', '2026-05-26', '2026-06-04 17:52:59', '2026-06-08 11:09:51', 0, 'https://lishaohan-oss.oss-cn-beijing.aliyuncs.com/1fcfe218-2537-476e-8d52-597eea51f8c2.png');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '护理区域表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '护理项目表' ROW_FORMAT = Dynamic;
...
INSERT INTO `nursing_item` VALUES (21, '晨间护理', '洗脸刷牙、整理床铺', 1, '每日1次', '2026-06-04 14:50:40', '2026-06-04 14:50:40', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '护理级别表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '护理记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '外出登记表' ROW_FORMAT = Dynamic;
...
INSERT INTO `outing` VALUES (31, 'O20260605-001', 20, '2026-06-11 00:00:00', '2026-06-16 00:00:00', '2026-06-10 00:00:00', '1', '外出中', '2026-06-05 15:12:26', '2026-06-05 15:12:26', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '服务购买表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '服务关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_user` VALUES (9, '13900000100', '$2a$10$lD9W1DlgGtRo9PHI5QLoNOXKNxbu3YLHpYLuu2I7qZdT9ctpfToQ', '林护士', 24, '女', 'ROLE_NURSE', 1, '2026-06-04 14:50:39', '2026-06-08 14:35:00', 0);
...
INSERT INTO `sys_user` VALUES (21, '13800000000', '$2a$10$ZNANAZ3bjC5w6rzoisztVukoQFg24PO10ShN7jpwD6v7AhzYBdL3G', '系统管理员', 42, '男', 'ROLE_ADMIN', 1, '2026-06-04 14:51:40', '2026-06-08 14:35:00', 0);
INSERT INTO `sys_user` VALUES (22, '13800000001', '$2a$10$9kWbDOQirhQPaZtla9jc0eK12zPxMOdUmpByO1uObB/wfiZON9yv.', '健康管家', 35, '女', 'ROLE_MANAGER', 1, '2026-06-04 14:51:40', '2026-06-08 14:35:00', 0);
INSERT INTO `sys_user` VALUES (23, '13800000002', '$2a$10$ZRQmuhVXLwVF0WXwYEuVPOW9nRff0MTf7Pc0/0ZZ7gG5/fip.GPGe', '普通客户', 68, '男', 'ROLE_USER', 1, '2026-06-04 14:51:40', '2026-06-04 21:00:42', 0);
INSERT INTO `sys_user` VALUES (29, '13460772822', '$2a$10$lD9W1DlgGtRo9PHI5QLoNOXKNxbu3YLHpYLuu2I7qZdT9ctpfToQ', '劳动法', 60, '男', 'ROLE_USER', 1, '2026-06-08 10:43:43', '2026-06-08 14:35:00', 0);
